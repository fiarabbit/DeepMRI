    ...
    with open("log.txt", "a") as f:
        ...
        for i_feature in range(0, 1000):
            for i, test_image_index in enumerate(range(len(test_dataset))):
                ...
                feature_coordinate = (i_feature, 0, 0, 0)
                ...
                if i % 150 == 149:
                    ...
                    with open(join(args.output, "grad_subject{}_feature{}.npz".format(i//150, i_feature)), "wb") as f_subject:
